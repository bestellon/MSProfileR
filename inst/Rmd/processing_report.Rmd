...
params$values$spectrumWithPeaksPlot
```
...
params$values$alignedSpectraPheatmap
```
...
cat('- Tolerance for reference binning:', params$values$values$binPeaksParams$binPeaksTolerance, '\n')
```
...
```{r, echo=FALSE, results='asis', eval=!isFALSE(params$values$binPeaksParams)}
cat('Number of peaks:', params$values$binnedPeakCount, '\n')
```

```{r, echo=FALSE, eval=!isFALSE(params$values$binPeaksParams)}
params$values$binnedPeaksPheatmap
```
...
```{r, echo=FALSE, results='asis', eval=!isFALSE(params$values$filterPeaksParams)}
cat('Number of peaks:', params$values$filteredPeakCount, '\n')
```

```{r, echo=FALSE, eval=!isFALSE(params$values$filterPeaksParams)}
params$values$filteredPeaksPheatmap
```
...
params$values$intensityMatrixPheatmap
```
